 ...
 * Each row links to the results and report pages for that session.
 */
function History() {
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 32px" }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ color: "var(--color-muted)", fontSize: 14 }}>
            All calibration sessions associated with your account.
          </p>
        </div>
        ...
        {sessions.length === 0 && !error ? (
          <div style={{
            ...
            <p style={{ color: "var(--color-muted)", fontSize: 14 }}>
              No calibration sessions found. Start by registering an instrument.
            </p>
            <button
 ...
 * Small outlined button for table row actions.
 */
